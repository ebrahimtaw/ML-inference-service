...
from sqlalchemy import select  # responsible for db requests

from config import engine  # responsible for db connection
from db.db_model import RentApartments  # represents the schema for our table

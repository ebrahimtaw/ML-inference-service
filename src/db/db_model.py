...
class RentApartments(Base):
    ...
    Attributes:
        ...
        construction_year (int): The year the apartment was constructed.
    ...
    address: Mapped[str] = mapped_column(NVARCHAR(), primary_key=True)
    ...
    zip: Mapped[str] = mapped_column(NVARCHAR())

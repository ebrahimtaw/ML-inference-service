...
class ModelInferenceService:
    """
    A service class for managing predictions.

    This class provides functionalities to load a ML model
    from a specified path, and make predictions using the loaded model.
    ...
    def load_model(self) -> None:
        ...
        logger.info(
            ...
            f"loading model configuraiton file",
        )
